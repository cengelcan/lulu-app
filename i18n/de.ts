...
export const de: Translations = {
  ...
  checkIn: {
    ...
    status: {
      appetite: {
        less: 'Isst weniger als üblich',
        normal: 'Frisst wie gewohnt',
        more: 'Isst mehr als üblich',
      },
      waterIntake: {
        less: 'Trinkt weniger als üblich',
        normal: 'Trinkt normal',
        more: 'Trinkt mehr als üblich',
      },
      poop: {
        not_observed: 'Heute nicht beobachtet',
        normal: 'Kot sieht normal aus',
        not_normal: 'Kot sieht ungewöhnlich aus',
      },
      pee: {
        not_observed: 'Heute nicht beobachtet',
        normal: 'Keine ungewöhnlichen Veränderungen',
        not_normal: 'Ungewöhnliches Urinieren',
      },
      energy: {
        low: 'Weniger aktiv als üblich',
        normal: 'Aktivität wirkt normal',
        high: 'Aktiver als üblich',
      },
      mood: {
        low: 'Wirkt unruhig',
        normal: 'Ruhig und zufrieden',
        high: 'Sehr verspielt und munter',
      },
    },
    options: {
      appetite: {
