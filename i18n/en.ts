  ...
  checkIn: {
    ...
    status: {
      ...
      poop: {
        ...
        normal: 'Stool looks normal',
        not_normal: 'Stool looks unusual',
      },
      pee: {
        not_observed: 'Not observed today',
        normal: 'No unusual changes',
        not_normal: 'Unusual urination',
      },
      energy: {
        low: 'Lower activity than usual',
        normal: 'Activity seems normal',
        high: 'More active than usual',
      },
      mood: {
        low: 'Seems unsettled',
        normal: 'Calm and happy',
        high: 'Very playful and upbeat',
      },
    },
    options: {
      appetite: {
