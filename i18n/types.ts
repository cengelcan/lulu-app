...
export type Translations = {
  ...
  vetVisits: {
    ...
    healthReport: string;
    attachHealthReport: string;
    healthReportDescription: string;
  ...
  sharing: {
    ...
    plusRequiredMessage: string;
    upgradeCta: string;
    setupTitle: string;
    setupMessage: string;
    enableSharing: string;
    familyCodeSection: string;
    familyCodeHint: string;
    copyCode: string;
    shareLink: string;
    rotateCode: string;
    rotateCodeTitle: string;
    rotateCodeMessage: string;
    rotateCodeConfirm: string;
    codeCopiedTitle: string;
    codeCopiedMessage: string;
    shareMessage: string;
    sharedPetsSection: string;
    membersSection: string;
    noMembers: string;
    unnamedMember: string;
    memberPetCount: string;
    removeMember: string;
    removeMemberTitle: string;
    removeMemberMessage: string;
    removeMemberConfirm: string;
    deactivateSharing: string;
    deactivateTitle: string;
    deactivateMessage: string;
    deactivateConfirm: string;
    joinIntro: string;
    joinCodeSection: string;
    joinCodeA11y: string;
    joinCodePlaceholder: string;
    previewJoin: string;
    joinPreviewSection: string;
    joinPreviewOwner: string;
    acceptJoin: string;
  ...
  paywall: {
    ...
    freeRecordsLimit: string;
    freeRemindersLimit: string;
  ...
  errors: {
    ...
    loadInbox: string;
    loadFamilySharing: string;
    familyGroupNotFound: string;
    invalidFamilyCode: string;
