...
const INBOX_ITEM_ICONS: Record<InboxItemKind, IconSymbolName> = {
  ...
  family_dose_taken: 'pills.fill',
  family_dose_skipped: 'pills.fill',
  family_dose_snoozed: 'clock.fill',
  family_medication_refilled: 'pills.fill',
  family_sharing_updated: 'person.2.fill',
